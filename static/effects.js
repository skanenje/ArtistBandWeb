import {
   ...
   // Initialize mouse and points to current cursor position
   function initCursorPosition() {
    ...
    updateMouse(event);
    points.forEach(point => point.copy(mouse));
   }
   
   // Call initCursorPosition when the page loads
   window.addEventListener('load', initCursorPosition);
